...
export default function Create({ auth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.client.store', [auth.user.id]));
    };
    ...
    return (
        <PanelLayout
            ...
            breadcrumbs={[
                ...
                {
                    text: "Création",
                    href: route("admin.client.create", [auth.user.id]),
                    active: true
                }
            ]}
        >
            ...
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 mt-1">Remplissez les informations ci-dessous pour créer un nouveau client</p>
                </div>

...
export default function Create({ auth, produits }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.stock.store', [auth.user.id]));
    };
    ...
    return (
        <PanelLayout
            ...
            breadcrumbs={[
                ...
                {
                    text: "Création",
                    href: route("admin.stock.create", [auth.user.id]),
                    active: true
                }
            ]}
        >
            <Head title="Créer un mouvement de stock" />

            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900">Créer un mouvement de stock</h1>
                    <p className="text-gray-500 mt-1">Enregistrez une entrée ou une sortie de stock</p>
                </div>

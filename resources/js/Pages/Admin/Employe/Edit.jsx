...
export default function Edit({ employe, auth, postes, departements }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        status: employe.status || true
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.employe.update', [auth.user.id, employe.id]));
    };
    ...
    return (
        <PanelLayout
            ...
            breadcrumbs={[
                ...
                {
                    text: "Modification",
                    href: route("admin.employe.edit", [auth.user.id, employe.id]),
                    active: true
                }
            ]}
        >
            ...
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 mt-1">Modifiez les informations de l'employé ci-dessous</p>
                </div>

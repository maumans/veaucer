...
export default function Edit({ fournisseur, auth }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        principal: fournisseur.principal || false,
        status: fournisseur.status || true
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.fournisseur.update', [auth.user.id, fournisseur.id]));
    };
    ...
    return (
        <PanelLayout
            ...
            breadcrumbs={[
                ...
                {
                    text: "Modification",
                    href: route("admin.fournisseur.edit", [auth.user.id, fournisseur.id]),
                    active: true
                }
            ]}
        >
            ...
            <div className="p-6">
                <div className="mb-6">
                    ...
                    <p className="text-gray-500 mt-1">Modifiez les informations du fournisseur ci-dessous</p>
                </div>

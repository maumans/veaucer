...
function Create({auth,error,errors,success,permissions,total,actif,inactif}) {
    ...
    return (
        <PanelLayout
            ...
            breadcrumbs={[
                {
                    text:"Role",
                    href:route("role.index",auth.user.id),
                    active:false
                },
                {
                    text:"Création",
                                        ...
                                        <div className={'flex flex-wrap gap-2'}>
                                            {
                                                permission.liste?.map((permission,index) =>(
                                                    <span key={index} className={"rounded border px-1"}>
                                                        <Checkbox onClick={handleChangeCheckbox} name={permission.id+''}/> {permission.libelle}
                                                    </span>
                                                ))
                                            }
                                        </div>

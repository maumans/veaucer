...
class ThemeController extends Controller
{
    public function index(Societe $societe)
    {
        ...
        return Inertia::render('SuperAdmin/Societe/Theme/Index', [
            'themes' => $themes,
    ...
    {
        return Inertia::render('SuperAdmin/Societe/Theme/Create', [
            'societe' => $societe->only('id', 'nom')
        ]);
    }
    ...
    public function store(Request $request, Societe $societe)
    {
        ...
        return redirect()->route('superAdmin.societe.theme.edit', ['societe' => $societe->id, 'theme' => $theme->id])
            ->with('success', 'Thème créé avec succès.');
    }

    public function edit(Societe $societe, Theme $theme)
    {
        return Inertia::render('SuperAdmin/Societe/Theme/Edit', [
            'theme' => $theme,
            'societe' => $societe->only('id', 'nom'),
            'preview' => [
    ...
    public function destroy(Societe $societe, Theme $theme)
    {
        ...
        return redirect()->route('superAdmin.societe.theme.index', ['societe' => $societe->id])

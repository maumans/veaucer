...
Route::middleware(['auth', "userIsAdmin", "profilActif"])->group(function () {
    ...
    Route::prefix('admin/{userId}/stock')->name('admin.stock.')->group(function () {
        Route::resource('produit', \App\Http\Controllers\Admin\Stock\ProduitController::class);
        Route::post('produit/paginationFiltre', [\App\Http\Controllers\Admin\Stock\ProduitController::class, 'paginationFiltre'])->name('produit.paginationFiltre');
        Route::get('produit/export-csv', [\App\Http\Controllers\Admin\Stock\ProduitController::class, 'exportCsv'])->name('produit.export-csv');
        Route::post('produit/import-csv', [\App\Http\Controllers\Admin\Stock\ProduitController::class, 'importCsv'])->name('produit.import-csv');

        ///STOCK

        // Routes pour les mouvements de stock
        Route::resource('mouvement', \App\Http\Controllers\Admin\Stock\MouvementController::class);
        Route::get('mouvement/{id}/cancel', [\App\Http\Controllers\Admin\Stock\MouvementController::class, 'cancel'])->name('mouvement.cancel');
        Route::get('mouvement-dashboard', [\App\Http\Controllers\Admin\Stock\MouvementController::class, 'dashboard'])->name('mouvement.dashboard');


        // Routes pour l'inventaire standard
        Route::resource('inventaire', \App\Http\Controllers\Admin\Stock\InventaireController::class);
        Route::post('inventaire/paginationFiltre', [\App\Http\Controllers\Admin\Stock\InventaireController::class, 'paginationFiltre'])->name('inventaire.paginationFiltre');
    });
